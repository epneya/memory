  ...
  var DRAWER = {
      ...
      init = function () {
       ...
       //INGAME
        ...
        gameObjects.ingame['tiles_list'] = [{id: '0', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 0, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '0', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 0, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '1', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 70, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '1', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 70, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '2', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 140, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '2', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 140, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '3', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 210, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '3', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 210, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '4', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 280, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '4', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 280, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '5', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 350, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '5', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 350, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '6', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 420, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '6', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 420, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '7', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 490, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '7', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 490, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '8', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 560, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '8', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 560, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '9', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 630, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '9', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 630, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '10', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 700, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '10', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 700, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '11', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 770, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '11', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 770, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '12', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 840, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '12', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 840, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '13', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 910, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '13', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 910, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '14', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 980, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '14', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 980, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '15', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 1050, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}},
                                            {id: '15', show: false, cords: {x: null, y: null}, draw: function () {if (this.show == true) {CTX.drawImage(img, 1050, 0, 70, 70, this.cords.x, this.cords.y, 70, 70);} else {CTX.font = "42px Pacifico"; CTX.fillText("?", this.cords.x + 35, this.cords.y + 35);}}}];
        gameObjects.ingame['field_list'] = [];
